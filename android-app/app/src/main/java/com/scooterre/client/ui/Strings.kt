...
val STRINGS_DE = AppStrings(
    ...
    docsScanHint = "Scannen öffnet die Kamera deines Handys (dort z. B. den Dokumentenmodus wählen) und danach die Auswahl der Aufnahmen. Die Fotos bleiben auch in der Galerie.",
    themeLight = "Hell",
    themeDark = "Dunkel",
...
val STRINGS_EN = AppStrings(
    ...
    docsScanHint = "Scan opens your phone's camera (choose e.g. its document mode there) and then the picker for the shots. The photos also stay in the gallery.",
    themeLight = "Light",
    themeDark = "Dark",
