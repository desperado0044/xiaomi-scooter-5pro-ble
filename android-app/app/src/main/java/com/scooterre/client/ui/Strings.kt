...
val STRINGS_DE = AppStrings(
    ...
    exploreHint = "Liest rein lesend durch, welche Werte dein Scooter liefert, und erzeugt einen Text zum Melden. Ändert nichts am Scooter. Dauert etwa eine Minute.",
...
val STRINGS_EN = AppStrings(
    ...
    exploreHint = "Reads which values your scooter offers, without writing anything, and creates a text to report. Changes nothing on the scooter. Takes about a minute.",
