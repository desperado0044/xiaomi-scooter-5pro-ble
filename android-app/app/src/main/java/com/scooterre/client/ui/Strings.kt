...
val STRINGS_DE = AppStrings(
    ...
    backupPassword = "Passwort (mindestens 8 Zeichen)",
    backupPasswordRepeat = "Passwort wiederholen",
    backupWarning = "Alle Scooter mit Schlüsseln, Dokumenten, Verlauf und App-Einstellungen in einer verschlüsselten Datei. Ohne dieses Passwort lässt sich die Sicherung nicht wiederherstellen - es gibt keine Rücksetzung.",
    backupInvalidPassword = "Die Passwörter stimmen nicht überein oder sind zu kurz.",
    ...
    backupTooLarge = "Die Sicherung wäre größer als 200 MB.",
    ...
    docsScanHint = "Scannen öffnet die Kamera deines Handys (dort z. B. den Dokumentenmodus wählen) und danach die Auswahl der Aufnahmen. Fotos: bereits vorhandene Fotos auswählen, mehrere = mehrere Seiten. Datei: PDF oder Bild aus dem Dateimanager.",
    themeLight = "Hell",
    themeDark = "Dunkel",
...
val STRINGS_EN = AppStrings(
    ...
    backupPassword = "Password (at least 8 characters)",
    backupPasswordRepeat = "Repeat password",
    backupWarning = "All scooters with keys, documents, history and app settings in one encrypted file. Without this password the backup cannot be restored - there is no reset.",
    backupInvalidPassword = "The passwords do not match or are too short.",
    ...
    backupTooLarge = "The backup would be larger than 200 MB.",
    ...
    docsScanHint = "Scan opens your phone's camera (choose e.g. its document mode there) and then the picker for the shots. Photos: pick existing photos, several = several pages. File: a PDF or image from the file manager.",
    themeLight = "Light",
    themeDark = "Dark",
