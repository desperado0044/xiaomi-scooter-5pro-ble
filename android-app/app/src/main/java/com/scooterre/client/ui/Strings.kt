...
val STRINGS_DE = AppStrings(
    ...
    forgetDeviceConfirmText = { name -> "Der gespeicherte Schlüssel für \"$name\" wird gelöscht - zum erneuten Verbinden ist wieder ein Login (Cloud/PIN) nötig." },
    exportDeviceButton = "Exportieren",
    exportDialogTitle = "Zugang exportieren",
    exportDialogHint = "Dieser Code enthält den vollständigen Zugangsschlüssel für diesen Scooter. Nur an Personen weitergeben, die den Scooter auch wirklich mitbenutzen dürfen (z.B. per WhatsApp/Signal) - nicht öffentlich teilen.",
    shareButton = "Teilen",
...
val STRINGS_EN = AppStrings(
    ...
    forgetDeviceConfirmText = { name -> "This removes the saved key for \"$name\" - you'll need to log in again (cloud/PIN) to reconnect it." },
    exportDeviceButton = "Export",
    exportDialogTitle = "Export access",
    exportDialogHint = "This code contains the full access key for this scooter. Only share it with people who are actually allowed to use the scooter too (e.g. via WhatsApp/Signal) - never share it publicly.",
    shareButton = "Share",
