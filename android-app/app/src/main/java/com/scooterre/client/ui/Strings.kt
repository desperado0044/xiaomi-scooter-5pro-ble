...
val STRINGS_DE = AppStrings(
    ...
    historyRangeHint = "Die Reichweite nach deinem Verbrauch rechnet den Rest im Akku mit deinem gemessenen Verbrauch je Modus hoch; neuere Fahrten zählen mehr. Sie erscheint ab 5 km Daten im jeweiligen Modus und nur aus Fahrten, die live aufgezeichnet wurden (Handy verbunden, App offen). Sonst gilt die Schätzung des Scooters.",
    ...
    rideTrackingLabel = "Fahrten live aufzeichnen",
    rideTrackingHint = "Zeichnet Kilometer und Verbrauch je Fahrmodus auf, solange dein Handy während der Fahrt mit dem Scooter verbunden ist. Daraus entsteht die Reichweite nach deinem Verbrauch. Ohne Verbindung gilt die Schätzung des Scooters.",
...
val STRINGS_EN = AppStrings(
    ...
    historyRangeHint = "The range at your consumption projects the energy left in the battery with the consumption measured per mode; newer rides count more. It appears once a mode has 5 km of data, and only from rides recorded live (phone connected, app open). Otherwise the scooter's own estimate applies.",
    ...
    rideTrackingLabel = "Record rides live",
    rideTrackingHint = "Records distance and consumption per riding mode while your phone is connected to the scooter during the ride. This builds the range at your consumption. Without a connection the scooter's own estimate applies.",
